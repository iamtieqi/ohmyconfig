...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     ;; ----------------------------------------------------------------
     (spacemacs-project)
     (c-c++ :variable c-c++-backend 'clangd)
     auto-completion
     better-defaults
     emacs-lisp
     ;; git
   ...
   dotspacemacs-additional-packages '(fanyi
                                      vscode-dark-plus-theme
                                      )

   ;; A list of packages that cannot be updated.
   dotspacemacs-frozen-packages '(vi-tilde-fringe)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("CaskaydiaCove Nerd Font Propo Light"
                               :size 15.0
                               :weight normal
                               :width normal)
...
before packages are loaded."
  ...
  (spacemacs/set-leader-keys "oo" 'fanyi-dwim)
  ...
  (spacemacs/set-leader-keys "RET" 'shell)
  ...
  ;; 1. 全局开启 projectile 模式
  (projectile-mode +1)

  ;; 2. 忽略目录（不索引、不搜索）
  (setq projectile-globally-ignored-directories
        '(".git" "node_modules" "build" "dist" "target" "venv" "__pycache__" ".venv" "cmake-build-*"))

  ;; 3. 忽略文件后缀
  (setq projectile-globally-ignored-file-suffixes
        '(".log" ".swp" ".pyc" ".o" ".class" ".exe"))
  ...
  ;; 6. 复制文件相对项目根路径（SPC p y）
  (spacemacs/set-leader-keys "py" #'projectile-copy-relative-path)

  ;; 7. 自定义快捷键：一键刷新项目缓存
  (spacemacs/set-leader-keys "pi" #'projectile-invalidate-cache)

  ;; 8. 使用 ag(The Silver Searcher) 加速项目搜索（需系统安装ag）
  (when (executable-find "ag")
    (setq projectile-grep-command "ag --nocolor --nogroup -s"))
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;vscode modeline theme;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  (defun modeline-vscode-pure-black ()
    ;; 基础状态栏整体底色
    (set-face-attribute 'mode-line nil
                        :background "#252526"   ; VSCode 活动状态栏纯黑
                        :foreground "#cccccc"   ; 主文字浅灰
                        :height 0.96)
    (set-face-attribute 'mode-line-inactive nil
                        :background "#1e1e1e"   ; 未激活窗口状态栏（编辑器底色）
                        :foreground "#858585")

    ;; spaceline 两段分割色块，统一黑色系，无蓝色
    (custom-set-faces
     ;; 激活窗口左段
     '(powerline-active1 ((t (:background "#252526" :foreground "#cccccc"))))
     ;; 激活窗口右段 稍微深一点分层
     '(powerline-active2 ((t (:background "#2c2c2c" :foreground "#bbbbbb"))))
     ;; 未激活两段统一更深黑
     '(powerline-inactive1 ((t (:background "#1e1e1e" :foreground "#999999"))))
     '(powerline-inactive2 ((t (:background "#1a1a1a" :foreground "#777777")))))

    ;; 覆盖 Evil 各模式颜色，强制全部黑色，不出现彩色条
    (custom-set-faces
     '(evil-normal-state-line ((t (:background "#252526" :foreground "#cccccc"))))
     '(evil-insert-state-line ((t (:background "#252526" :foreground "#cccccc"))))
     '(evil-visual-state-line ((t (:background "#252526" :foreground "#cccccc"))))
     '(evil-replace-state-line ((t (:background "#252526" :foreground "#cccccc"))))))

  ;; 切换主题自动刷新配色
  (add-hook 'spacemacs-post-theme-change-hook #'modeline-vscode-pure-black)
  ;; 启动立即生效
  (modeline-vscode-pure-black)
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-link afternoon-theme aggressive-indent alect-themes alert all-the-icons
                ample-theme ample-zen-theme anti-zenburn-theme apropospriate-theme
                ...
                clues-theme cmake-mode color-theme-sanityinc-solarized
                color-theme-sanityinc-tomorrow column-enforce-mode
                company-c-headers cpp-auto-include cyberpunk-theme dakrone-theme
                ...
                dumb-jump eat ef-themes elisp-def elisp-demos elisp-slime-nav emr
                ...
                fanyi farmhouse-themes flatland-theme flatui-theme flycheck-elsa
                flycheck-package flycheck-pos-tip gandalf-theme gendoxy gntp
                gnuplot golden-ratio google-c-style google-translate gotham-theme
                grandshell-theme gruber-darker-theme gruvbox-theme
                hc-zenburn-theme helm-ag helm-c-yasnippet helm-comint helm-company
                helm-ctest helm-descbinds helm-lsp helm-make helm-mode-manager
                ...
                jbeans-theme kaolin-themes light-soap-theme link-hint log4e
                ...
                multi-vterm mustang-theme mwim nameless naquadah-theme
                ...
                org-superstar organic-green-theme overseer page-break-lines
                ...
                rebecca-theme restart-emacs reverse-theme seti-theme shell-pop
                ...
                term-cursor terminal-here toc-org toxi-theme transient
                ...
                vundo wgrep white-sand-theme winum writeroom-mode ws-butler yaml
